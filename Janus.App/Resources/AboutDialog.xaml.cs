...
public partial class AboutDialog : Window {
  ...
  private async void AnimateCopyrightAsync(CancellationToken token) {
    ...
    while (!token.IsCancellationRequested) {
      await Dispatcher.InvokeAsync(() => {
        ...
        switch (animType) {
          case 0: AnimateMove(); break;
          case 1: AnimateRotate(); break;
          case 2: AnimateScale(); break;
          case 3: AnimateCombo(); break;
          case 4: AnimateCartwheel(rotate.Angle); break;
          case 5: AnimateBarrel(); break;
          case 6: AnimateShiver(); break;
          case 7: AnimatePop(); break;
          case 8: AnimateFlip(); break;
          case 9: AnimateWobble(rotate.Angle); break;
          case 10: AnimateRainbowPulse(); break;
          case 11: AnimateSlideOutIn(); break;
          case 12: AnimateBounce(); break;
          case 13: AnimateSquashStretch(); break;
          case 14: AnimateFade(); break;
          case 15: AnimateSpiral(translate.X, translate.Y); break;
        }
      });

      try {
        await Task.Delay((int)(700 + _rnd.NextDouble() * 1000), token);
  ...
  private void AnimateMove() {
    ...
    double x = _rnd.NextDouble() * 240 - 120;
    double y = _rnd.NextDouble() * 80 - 40;
    var ax = new DoubleAnimation(x, TimeSpan.FromSeconds(_rnd.NextDouble() * 0.7 + 0.6)) { EasingFunction = new SineEase() };
    var ay = new DoubleAnimation(y, TimeSpan.FromSeconds(_rnd.NextDouble() * 0.7 + 0.6)) { EasingFunction = new SineEase() };
  ...
  private void AnimateRotate() {
    var sb = new Storyboard();
    double angle = _rnd.NextDouble() * 1080 - 540;
    var a = new DoubleAnimation(angle, TimeSpan.FromSeconds(_rnd.NextDouble() * 0.7 + 0.6)) { EasingFunction = new SineEase() };
  ...
  private void AnimateScale() {
    var sb = new Storyboard();
    double scaleTo = _rnd.NextDouble() * 1.2 + 0.4;
    var ax = new DoubleAnimation(scaleTo, TimeSpan.FromSeconds(_rnd.NextDouble() * 0.7 + 0.6)) { EasingFunction = new SineEase() };
    var ay = new DoubleAnimation(scaleTo, TimeSpan.FromSeconds(_rnd.NextDouble() * 0.7 + 0.6)) { EasingFunction = new SineEase() };
    Storyboard.SetTarget(ax, CopyrightText);
  ...
  private void AnimateCombo() {
    ...
    var ax = new DoubleAnimation(x, TimeSpan.FromSeconds(_rnd.NextDouble() * 0.7 + 0.6)) { EasingFunction = new SineEase() };
    var ay = new DoubleAnimation(y, TimeSpan.FromSeconds(_rnd.NextDouble() * 0.7 + 0.6)) { EasingFunction = new SineEase() };
    var arot = new DoubleAnimation(angle, TimeSpan.FromSeconds(_rnd.NextDouble() * 0.7 + 0.6)) { EasingFunction = new SineEase() };
    var asx = new DoubleAnimation(scaleTo, TimeSpan.FromSeconds(_rnd.NextDouble() * 0.7 + 0.6)) { EasingFunction = new SineEase() };
    var asy = new DoubleAnimation(scaleTo, TimeSpan.FromSeconds(_rnd.NextDouble() * 0.7 + 0.6)) { EasingFunction = new SineEase() };
    Storyboard.SetTarget(ax, CopyrightText);
    Storyboard.SetTargetProperty(ax, new PropertyPath("RenderTransform.Children[2].X"));
    Storyboard.SetTarget(ay, CopyrightText);
    Storyboard.SetTargetProperty(ay, new PropertyPath("RenderTransform.Children[2].Y"));
  ...
  private void AnimateCartwheel(double currentAngle) {
    var sb = new Storyboard();
    double angle = currentAngle + (_rnd.Next(2) == 0 ? 360 : -360) * (_rnd.Next(2) + 1);
    var a = new DoubleAnimation(angle, TimeSpan.FromSeconds((_rnd.NextDouble() * 0.7 + 0.6) * 0.7)) { EasingFunction = new CubicEase() };
    Storyboard.SetTarget(a, CopyrightText);
    Storyboard.SetTargetProperty(a, new PropertyPath("RenderTransform.Children[1].Angle"));
    sb.Children.Add(a);
    sb.Begin();
  ...
  private void AnimateBarrel() {
    var sb = new Storyboard();
    double sx = _rnd.NextDouble() * 1.2 + 0.4;
    double sy = 2.0 - sx;
    var ax = new DoubleAnimation(sx, TimeSpan.FromSeconds(_rnd.NextDouble() * 0.7 + 0.6)) { EasingFunction = new SineEase() };
    var ay = new DoubleAnimation(sy, TimeSpan.FromSeconds(_rnd.NextDouble() * 0.7 + 0.6)) { EasingFunction = new SineEase() };
    Storyboard.SetTarget(ax, CopyrightText);
    Storyboard.SetTargetProperty(ax, new PropertyPath("RenderTransform.Children[0].ScaleX"));
    Storyboard.SetTarget(ay, CopyrightText);
    Storyboard.SetTargetProperty(ay, new PropertyPath("RenderTransform.Children[0].ScaleY"));
  ...
  private void AnimateShiver() {
    var sb = new Storyboard();
    for (int i = 0; i < 6; i++) {
      double x = (i % 2 == 0 ? 1 : -1) * (_rnd.NextDouble() * 20 + 10);
  ...
  private void AnimateWobble(double baseAngle) {
    var sb = new Storyboard();
    for (int i = 0; i < 6; i++) {
  ...
  private void AnimateRainbowPulse() {
    var brush = CopyrightText.Foreground as SolidColorBrush;
    var sb = new Storyboard();
    for (int i = 0; i < 6; i++) {
      var to = DarkVividColors[_rnd.Next(DarkVividColors.Length)];
  ...
  private void AnimateSlideOutIn() {
    var sb = new Storyboard();
    double x = (_rnd.Next(2) == 0 ? 1 : -1) * (_rnd.NextDouble() * 400 + 200);
  ...
  private void AnimateSpiral(double baseX, double baseY) {
    var sb = new Storyboard();
    for (int i = 0; i < 8; i++) {
  ...
  private async void Window_Loaded(object sender, RoutedEventArgs e) {
    ...
    while (IsVisible) {
      ...
      var to = DarkVividColors[_rnd.Next(DarkVividColors.Length)];
      var anim = new ColorAnimation(from, to, new Duration(TimeSpan.FromSeconds(_rnd.NextDouble() * 1.5 + 1.0))) {
        EasingFunction = new SineEase()
      };
      brush.BeginAnimation(SolidColorBrush.ColorProperty, anim);
      await Task.Delay((int)(1000 + _rnd.NextDouble() * 1200));
    }
  }
